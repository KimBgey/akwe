...
function Sidebar() {
  return (
    <nav className="flex flex-col rounded-3xl border border-white/8 bg-surface-1/90 backdrop-blur-xl shadow-[0_8px_40px_rgba(0,0,0,0.6)] overflow-hidden h-full">
      {/* Logo */}
...
function AppShell() {
  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen bg-surface-0 text-white selection:bg-brand-500/30">
